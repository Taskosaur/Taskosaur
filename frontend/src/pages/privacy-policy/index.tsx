          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
            <section className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                At Taskosaur, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose,
                and safeguard your information when you use our project management platform.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-medium text-foreground">3.2 Within Your Organization</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Information within workspaces is shared with other members according to the permissions and roles set by workspace administrators.
                </p>
              </div>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                When your account is deleted, we will delete or anonymize your personal information within 90 days,
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  You can request deletion of your account and personal information by contacting support.
                </p>
              </div>

              <div className="space-y-3">
                <h3 className="text-xl font-medium text-foreground">6.4 Communication Preferences</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                additional notice via email or through the Service.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="pl-6 space-y-1 text-muted-foreground">
                <p>Email: privacy@taskosaur.com</p>
                <p>Data Protection Officer: dpo@taskosaur.com</p>
              </div>
            </section>
          </div>
          ...
          <div className="pt-8 border-t">
            <div className="space-y-4">
              <p className="text-center text-sm text-muted-foreground">
                By using Taskosaur, you acknowledge that you have read and understood this Privacy Policy.
              </p>
              <p className="text-center text-sm text-muted-foreground">
                View our{' '}
