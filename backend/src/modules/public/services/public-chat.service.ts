...
import { ProjectChartDataResponse, ProjectChartType, ProjectKPIMetrics, SprintVelocity, TaskStatusFlow } from 'src/modules/projects/dto/get-project-charts-query.dto';
...
export class ProjectChartsService {
    ...
    private async getProjectWithVisibilityCheck(projectSlug: string) {
        ...
        if (project.visibility !== 'PUBLIC') {
            throw new UnauthorizedException('This project is not publicly accessible');
        }
