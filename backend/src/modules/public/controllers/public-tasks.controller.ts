...
export class PublicTasksController {
  ...
  @ApiQuery({ name: 'limit', description: 'Number of tasks to return', required: false })
  @ApiQuery({ name: 'offset', description: 'Number of tasks to skip', required: false })
  @ApiQuery({ name: 'status', description: 'Filter by status name', required: false })
  @ApiQuery({ name: 'priority', description: 'Filter by priority', required: false })
  @ApiQuery({ name: 'type', description: 'Filter by task type', required: false })
  @ApiQuery({
    name: 'parentTaskId',
    required: false,
  ...
  async getTasks(
    ...
    return this.publicTasksService.getPublicTasks(workspaceSlug, projectSlug, filters);
  }
  ...
  async getTasksKanban(
    ...
    return this.publicTasksService.getPublicTasksKanban(workspaceSlug, projectSlug);
  }
