...
export class PublicCalendarController {
  ...
  @ApiQuery({ name: 'startDate', description: 'Start date for events (YYYY-MM-DD)', required: false })
  @ApiQuery({ name: 'endDate', description: 'End date for events (YYYY-MM-DD)', required: false })
