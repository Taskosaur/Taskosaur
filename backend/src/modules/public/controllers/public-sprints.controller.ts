...
export class PublicSprintsController {
  ...
  async getSprints(
    ...
    return this.publicSprintsService.getPublicSprints(workspaceSlug, projectSlug);
  }
  ...
  async getSprint(
    ...
    return this.publicSprintsService.getPublicSprint(workspaceSlug, projectSlug, sprintId);
  }
  ...
  async getSprintTasks(
    ...
    return this.publicSprintsService.getPublicSprintTasks(workspaceSlug, projectSlug, sprintId);
  }
}